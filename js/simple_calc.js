...
document.getElementById("btnClearAcqu").addEventListener("click", clear);




// ROI
var btnCalcRoi = document.getElementById("btnCalcRoi");
var btnClearRoi = document.getElementById("btnClearRoi");
...
function calcRoi (){
    ...
    if (holdings != 0 && BuySellPrev != 0 || BuySellCurr != 0) {
      ...
      Roi.innerHTML = resultRoi.toExponential(4);
    } else {
    ...
    if(resultRoi < 0){
      ...
      if(RoiPctChange > 500000000000) {
        document.getElementById("roiPct").innerHTML ="<i class=\"fas fa-sort-down\"></i>"+ RoiPctChange.toExponential(4) +"%";
      } else {
      ...
      if(RoiPctChange > 500000000000) {
        document.getElementById("roiPct").innerHTML ="<i class=\"fas fa-sort-up\"></i>"+ RoiPctChange.toExponential(4) +"%";
      } else {
...
btnCalcRoi.addEventListener("click", calcRoi);
...
var btnClearMult = document.getElementById("btnClearMult");
...
function covertor(){
  ...
  if(holdMult > 0 || priceMult > 0 ){
    ...
    if(result > 500000000000){
      MultOutput.innerHTML = result.toExponential(4);
...
btnClearMult.addEventListener("click", clearConverotr);
